---
title: Keeping good looks in a pandemic
author: Chantel Teague
date: 2020-04-16
hero: ./images/hero-2.jpg
excerpt: With the Covid-19 pandemic, we hope to create more resources that make it easier for anyone able to give themselves good looks.
---

Hello, world! This is a big demo post for `gatsby-theme-novela`. Novela is built by the team at [Narative](https://narative.co), and built for everyone that loves the web.
